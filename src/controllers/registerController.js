...
export const register= async function(datas)
{
    //url webservices
    ...
    formData.append('telefono', datas.telefono)
    formData.append('dni', datas.dni)
    ...
    try
    {
        ...
        console.log("jsonresponse",data);
            switch(rdo)
            {
                ...
                {
                    //guardo token
                    localStorage.setItem("x",data.createdUser.token);
